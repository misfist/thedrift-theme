...
module.exports = {
	...
	theme: {
		...
		fontFamily: {
			sans: [ 'AvenirNext-Thin', 'sans-serif' ],
			serif: [ 'Adobe Caslon', 'serif' ],
			alt: [ 'Franklin Gothic', 'sans-serif' ],
		},
		spacing: {
			px: '1px',
			0: '0',
		...
		plugin( function ( { addBase, config } ) {
			addBase( {
				...
				p: {
					...
					marginBottom: config( 'theme.spacing.24' ),
					'&:last-child': {
						marginBottom: '0',
					},
				},
				...
				'.entry-meta': {
					fontFamily: config( 'theme.fontFamily.alt' ),
